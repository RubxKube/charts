...
![Version: 1.2.7](https://img.shields.io/badge/Version-1.2.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.10.1-nginx](https://img.shields.io/badge/AppVersion-0.10.1--nginx-informational?style=flat-square)
...
| common.image.tag | string | `"0.10.1-nginx"` |  |
