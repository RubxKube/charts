...
![Version: 1.1.13](https://img.shields.io/badge/Version-1.1.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.32.6](https://img.shields.io/badge/AppVersion-1.32.6-informational?style=flat-square)

Vaultwarden is an easy-to-use self-hosted password manager.
...
| common.image.tag | string | `"1.32.6"` |  |
...
| common.ingress.hostName | string | `"vaultwarden.une-tasse-de.cafe"` |  |
...
| common.variables.nonSecret.DOMAIN | string | `"https://vaultwarden.example.com"` |  |
